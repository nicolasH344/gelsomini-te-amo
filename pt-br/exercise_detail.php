    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        <div class="mb-3">
                            <label for="user_code" class="form-label">Seu Código:</label>
                    ...
                    <div id="solution" class="mt-4" style="display: none;">
                        <h5>Solução:</h5>
                        <pre class="bg-light p-3 rounded"><code><?php echo sanitize($exercise['solution_code'] ?? 'Solução não disponível'); ?></code></pre>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <p><strong>Categoria:</strong> <?php echo sanitize($exercise['category_name']); ?></p>
                    ...
                    <p><strong>Tipo:</strong> <?php echo strtoupper($exercise['exercise_type']); ?></p>
                </div>
            </div>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <a href="exercises_index.php" class="btn btn-secondary btn-sm">
                        <i class="fas fa-arrow-left"></i> Voltar aos Exercícios
                    </a>
                </div>
            </div>
        </div>
