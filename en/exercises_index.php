                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" id="difficulty" name="difficulty">
                            ...
                            <option value="Iniciante" <?php echo ($difficulty === 'Iniciante') ? 'selected' : ''; ?>>Beginner</option>
                            <option value="Intermediário" <?php echo ($difficulty === 'Intermediário') ? 'selected' : ''; ?>>Intermediate</option>
                            <option value="Avançado" <?php echo ($difficulty === 'Avançado') ? 'selected' : ''; ?>>Advanced</option>
                        </select>
                    </div>
