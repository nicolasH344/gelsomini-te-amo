    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        <div class="mb-3">
                            <label for="user_code" class="form-label">Tu Código:</label>
                    ...
                    <div id="solution" class="mt-4" style="display: none;">
                        <h5>Solución:</h5>
                        <pre class="bg-light p-3 rounded"><code><?php echo sanitize($exercise['solution_code'] ?? 'Solución no disponible'); ?></code></pre>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <p><strong>Categoría:</strong> <?php echo sanitize($exercise['category_name']); ?></p>
