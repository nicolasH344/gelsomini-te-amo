        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4">
                    ...
                    <p class="text-muted">
                        <?php echo t('footer_description', 'Plataforma interactiva para aprender desarrollo web con ejercicios prácticos, tutoriales detallados y una comunidad de desarrolladores activa.'); ?>
                    </p>
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    <h6 class="fw-semibold mb-3"><?php echo t('resources', 'Características'); ?></h6>
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a href="#" class="text-muted text-decoration-none">
                                <?php echo t('documentation', 'Documentación'); ?>
                            </a>
                        </li>
                        <li class="mb-2"> 
                            <a href="#" class="text-muted text-decoration-none">
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a href="#" class="text-muted text-decoration-none">
                                <?php echo t('help_center', 'Centro de ayuda'); ?>
                            </a>
                        </li>
                        <li class="mb-2"> 
                            <a href="#" class="text-muted text-decoration-none">
                                <?php echo t('contact', 'Contacto'); ?>
                            </a>
                        </li> 
                        <li class="mb-2">
                            <a href="#" class="text-muted text-decoration-none">
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a href="#" class="text-muted text-decoration-none">
                                <?php echo t('privacy_policy', 'política de privacidad'); ?>
                            </a>
                        </li>
                        <li class="mb-2"> 
                            <a href="#" class="text-muted text-decoration-none">
                                <?php echo t('terms_of_service', 'Términos de servicio'); ?>
                            </a>
                        </li> 
                        <li class="mb-2">
                            <a href="#" class="text-muted text-decoration-none">
                                <?php echo t('cookies', 'Galletas'); ?>
                            </a>
                        </li> 
                        <li class="mb-2">
                            <a href="#" class="text-muted text-decoration-none">
                                <?php echo t('accessibility_statement', 'Declaración de accesibilidad'); ?>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="text-muted mb-0">
                        ...
                        <?php echo t('all_rights_reserved', 'Reservados todos los derechos.'); ?>
                    </p>
                </div>
                <div class="col-md-6 text-md-end">
                    <div class="d-flex justify-content-md-end gap-3 mt-3 mt-md-0">
                        <span class="text-muted small">
                            ...
                            <?php echo t('made_with_love', 'Hecho con amor'); ?>
                        </span>
                        <span class="text-muted small">
                            <i class="fas fa-universal-access me-1" aria-hidden="true"></i>
                            <?php echo t('accessible_design', 'Diseño accesible'); ?>
                        </span>
                    </div>
                </div>
            </div>
    ...
    <button id="backToTop" class="btn btn-primary position-fixed bottom-0 end-0 m-4 rounded-circle" 
            ...
            onclick="scrollToTop()" 
            aria-label="<?php echo t('back_to_top', 'Volver arriba'); ?>"
            title="<?php echo t('back_to_top', 'Volver arriba'); ?>">
