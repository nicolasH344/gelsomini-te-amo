...
<!-- Carrega estilos específicos do componente (moved from inline) -->
<link rel="stylesheet" href="components/course-info.css">

<!-- Ajustes locais de estilo: título, descrição e ícones em preto para melhor contraste e visibilidade -->
<style>
    /* Título principal em preto, negrito para destaque */
    .header-title {
        color: #1a1a1a !important;
        font-weight: 700 !important;
    }

    /* Descrição do header em preto */
    .header-description {
        color: #1a1a1a !important;
        font-weight: 600 !important;
    }

    /* Badges em preto para melhor destaque */
    .badges-row .badge-modern {
        color: #000 !important;
        font-weight: 600 !important;
    }

    /* Ícones e metadados em preto */
    .metadata-icon {
        color: #1a1a1a !important;
    }
    ...
    /* Títulos de seções do conteúdo em preto e negrito */
    .section-title {
        color: #1a1a1a !important;
        font-weight: 700 !important;
    }

    /* Subtítulos (h4, h5, h6) dentro de content-block em preto */
    .content-block h4,
    .content-block h5,
    .content-block h6 {
        color: #1a1a1a !important;
    ...
    /* Texto geral do conteúdo em preto */
    .content-block p,
    .tutorial-content p,
    .about-tutorial,
    .exercise-description-box p {
        color: #1a1a1a !important;
    }
    ...
    /* Card de informações na sidebar */
    .info-card h4,
    .info-card h5,
    .info-card h6 {
        color: #1a1a1a !important;
    ...
    /* Garantir que texto em qualquer elemento seja preto */
    .content-section,
    .main-content-card,
    .action-card {
        color: #1a1a1a !important;
                ...
                <div class="header-content">
                    ...
                    <div class="metadata-grid-modern">
                        ...
                        <div class="metadata-card">
                            ...
                            <div class="metadata-text">
                                <span class="metadata-label">Autor</spde exean>
                            ...
                            <?php if ($type === 'tutorial'): ?>
                                <section class="content-section">
                                    ...
                                    <div class="tutorial-content">
                                        <div class="content-block about-tutorial">
                                        ...
                                        <div class="content-block example-practice">
